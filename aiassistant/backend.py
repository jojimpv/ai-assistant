"""
This script contains the methods being executed during UI actions like uploading document.
It performs adding/updating the database entries for background processes like form parsing and auto QA.
"""
import os
import time
